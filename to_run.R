...
it_object_RData_file_toload_prefix<-NA ##"it_object_2020422" ## set to NA if you want to rerun the analysis completely including the downloading of the data via COVID, otherwise it is the prefix of the .RData file where the data prepared for plotting by the scripts is stored
